(function(){
    ...
    (function() {
      ...
      setModule('AuthenticatedAPI', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          AuthenticatedAPI = (function(superClass) {
            ...
            extend(AuthenticatedAPI, superClass);
      ...
      setModule('AudioStation', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          AudioStation = (function(superClass) {
            extend(AudioStation, superClass);
      ...
      setModule('DownloadStation', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          DownloadStation = (function(superClass) {
            extend(DownloadStation, superClass);
      ...
      setModule('SurveillanceStation', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          SurveillanceStation = (function(superClass) {
            extend(SurveillanceStation, superClass);
      ...
      setModule('Syno', function() {
        ...
        exports = module.exports = {};
        (function(modules, module, exports, setModule, setter) {
          var Syno, axios, defaults, endsWith, filter, first, flatten, fs, https, isArray, keys, last, mapValues, merge, path, ref, some, startsWith, values;
            ...
            function Syno(params) {
              ...
              if (this.debug) {
                axiosInstance.interceptors.request.use(function(config) {
                  var ref1;
                  console.log('[DEBUG] Request:', (ref1 = config.method) != null ? ref1.toUpperCase() : void 0, config.url, config.params);
                  return config;
                });
                  ...
                  for (j = 0, len1 = apiKeys.length; j < len1; j++) {
                    ...
                    if (definitions[api].methods) {
                      ...
                      results1.push((function() {
                        var k, len2, results2;
                        results2 = [];
                        for (k = 0, len2 = lastApiVersionMethods.length; k < len2; k++) {
                          method = lastApiVersionMethods[k];
      ...
      setModule('VideoStation', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          VideoStation = (function(superClass) {
            extend(VideoStation, superClass);
      ...
      setModule('VideoStationDTV', function() {
        ...
        (function(modules, module, exports, setModule, setter) {
          ...
          VideoStationDTV = (function(superClass) {
            extend(VideoStationDTV, superClass);
